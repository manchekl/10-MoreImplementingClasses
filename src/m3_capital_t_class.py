...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def clone(self):
        ...
        #######################################################################
        fake=CapitalT(rg.Point(0,0),0,0,0)
        fake.h_rect=self.h_rect.clone()
        fake.v_rect=self.v_rect.clone()

        fake.h_rect.fill_color=self.h_rect.fill_color
        fake.v_rect.fill_color=self.v_rect.fill_color

        fake.h_rect.outline_color = self.h_rect.outline_color
        fake.v_rect.outline_color = self.v_rect.outline_color
