...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.save_start=self.start.clone()
        self.save_end=self.end.clone()
    ...
    def length(self):
        ...
        xval=(self.end.x-self.start.x)**2
        yval=(self.end.y-self.start.y)**2

        length = math.sqrt(xval+yval)
        return length
